        ...
        with self.SessionLocal() as session:
            for parsed_event, raw_event in zip(parsed_events, raw_event):
                ev = Events(
                    ...
                    home_score_ht=safe_get(parsed_event, "homeScore", "period1"),
                    home_score=safe_get(parsed_event, "homeScore", "display"),
                    away_score_ht=safe_get(parsed_event, "awayScore", "period1"),
                    away_score=safe_get(parsed_event, "awayScore", "display"),
                    winner_code=safe_get(parsed_event, "winnerCode"),
